# Spring PetClinic Sample Application [![Build Status][![Java CI with Maven](https://github.com/salshamary/spring-petclinic/actions/workflows/maven.yml/badge.svg)](https://github.com/salshamary/spring-petclinic/actions/workflows/maven.yml)
